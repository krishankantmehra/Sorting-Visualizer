...
function disableOthers() {
    ...
    $(".algo-btn-disable").prop("disabled",true);
}
...
function enableOthers() {
    ...
    $(".algo-btn-disable").prop("disabled",false)
...
$(document).ready(function() {
    ...
    $(".algo-btn").click(
        function() {
            ...
            $(".algo-btn").removeClass('algo-btn-active');
            $(".algo-btn").addClass('algo-btn-disable');
            $(this).addClass('algo-btn-active');
            $(this).removeClass('algo-btn-disable');
